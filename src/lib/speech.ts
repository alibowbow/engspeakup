...
export const GEMINI_TTS_VOICES: GeminiTtsVoiceOption[] = [
  ...
  { name: 'Achernar', tone: 'Soft', group: 'female', sampleText: "Hi, I'm Achernar. Let's practice English with a softer, calmer delivery." },
  ...
  { name: 'Gacrux', tone: 'Mature', group: 'female', sampleText: "Hi, I'm Gacrux. Let's practice mature, grounded English conversation." },
  { name: 'Iapetus', tone: 'Clear', group: 'male', sampleText: "Hi, I'm Iapetus. I'll keep the English pronunciation clear and steady." },
  { name: 'Kore', tone: 'Firm', group: 'female', sampleText: "Hi, I'm Kore. Let's train clear and confident English for real conversations." },
  ...
  { name: 'Zephyr', tone: 'Bright', group: 'female', sampleText: "Hi, I'm Zephyr. Let's practice bright and clean English conversation together." },
