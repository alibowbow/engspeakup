...
const NAVS: Array<{ id: PracticeView; label: string; mobileLabel: string; hint: string; icon: IconName }> = [
  { id: 'practice', label: '대화 연습', mobileLabel: '연습', hint: '실전 대화', icon: 'chat' },
  { id: 'library', label: '시나리오', mobileLabel: '시나', hint: '상황 라이브러리', icon: 'library' },
  { id: 'review', label: '복습', mobileLabel: '복습', hint: '저장 문장과 노트', icon: 'bookmark' },
  { id: 'analytics', label: '통계', mobileLabel: '통계', hint: '학습 진행 현황', icon: 'chart' },
];
